...
<div class="size">
    <div class="row  m-0 p-0">
                ...
                <div class="container1">
                    <div class="appointment-form" id="appointment-form">
                        ...
                        <div class="form-group-1">
                            ...
                            <input type="number" name="age" id="age" placeholder="{{__('register.age')}}"/>
                            ...
                            <div class="select-list">
                                ...
                                <select name="course_type" id="course_type">
                                    ...
                                    <option value="node-full">Full Stack Node Development</option>
                                    <option value="php-full">Full Stack PHP Development</option>
                                    <option value="python-full">Full Stack Python Development</option>
                                    <option value="react-front">Front-End React Development</option>
                                    <option value="php-back">Back-End Php Development</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-check">
                                <div>
                                    <input type="checkbox" name="morningtime" id="morningtime" class="morningtime"
                                           checked/>
                                    <label for="morningtime" class="label-agree-term ml-0"><span><span></span></span>09:00
                                        - 12:00</label>
                                </div>
                                <div>
                                    <input type="checkbox" name="daytime" id="daytime" class="daytime " checked/>
                                    <label for="daytime" class="label-agree-term ml-4"><span><span></span></span>12:00 -
                                        17:00</label>
                                </div>
                                <div>
                                    <input type="checkbox" name="eveningtime" id="eveningtime" class="eveningtime"
                                           checked/>
                                    <label for="eveningtime" class="label-agree-term ml-4"><span><span></span></span>17:00
                                        - 22:00</label>
                                </div>
        ...
        <div class=" col-lg-6 col-xl-6 p-0  colLeft"
    ...
    margin-top: 40px;">
                ...
                <p><span>{{__('register.phone')}}</span> <a href="callto:+37498757350">+374 98 75-73-50 </a> <a
                            href="callto:+37455757350"> +374 55 75-73-50 </a><a href="callto:+37433757350"> +374 33
                        75-73-50 </a></p>
                <p><span>{{__('register.email')}}</span> <a href="mailto:#">colibrilabcenter@gmail.com, </a><a
                            href="mailto:#"> info@colibrilab.am</a></p>

                <p><span>{{__('register.addr')}}</span> <a
                            href="https://goo.gl/maps/p1XuY33NcREqXVPP6">{{__('register.address')}}</a></p>
                <div class="list ">
                    <p>
                        <a
                                href="https://www.facebook.com/%D4%BF%D5%B8%D5%AC%D5%AB%D5%A2%D6%80%D5%AB%D4%BC%D5%A1%D5%A2-%D5%B8%D6%82%D5%BD%D5%B8%D6%82%D5%B4%D5%B6%D5%A1%D5%AF%D5%A1%D5%B6-%D5%AF%D5%A5%D5%B6%D5%BF%D6%80%D5%B8%D5%B6-1495050270734324"
                                target="_blank"><i
...
<script>
    $(document).ready(function () {
        ...
        let chosenCourse = "{{request()->query('course')}}";
        if (chosenCourse) {
            let chosenStack = $('#course_type  > li[value=' + chosenCourse + ']').text()
            $('#course_type li.init').text(chosenStack)
        }
