                    ...
                    <div class="container1">
                        ...
                        <div class="container1-divider"> Կամ </div> -->
                                ...
                                <div class="form-group-1">
                                    ...
                                    <div class="under-input"><input type="number" name="name" id="age"
                                    ...
                                    <div class="under-input"><input type="text" name="name" id="phone"
                                                                    placeholder="{{__('register.phone')}}"/></div>
                                    <div class="under-input">
                                        <select name="course" id="course">
                                            <option value="" disabled selected>{{__('register.course')}}</option>
                                            <option value="Full Stack Node Development">Full Stack Node Development
                                            </option>
                                            <option value="Full Stack PHP Development">Full Stack PHP Development
                                            </option>
                                            <option value="Full Stack Python Development">Full Stack Python Development
                                            </option>
                                            <option value="Front End React Development">Front End React Development
                                            </option>
                                            <option value="Back End PHP Development">Back End PHP Development</option>
                                        </select>
                                    </div>
                                    <div class="under-input">
                                        <select name="course_type" id="students_count">
                                            <option value="" disabled
                                                    selected>{{__('register.numberofstudents')}}</option>
                                ...
                                <select name="confirm_type" id="confirm_type">
                                    ...
                                    <div id="course_time" class="oclock-wrapper">
                                    ...
                                    <textarea id="comment" class="textarea-wrapper"
            ...
            <div class=" col-lg-6 col-xl-6  colLeft custom-left-column ">
                ...
                <div class="contact  w-100  right">
                    ...
                    <p class="contact-details">
                        <span>{{__('register.phone')}}:</span> <a href=" callto:+37498757350">+374 98 75-73-50
                        </a>
                        <a href="callto:+37455757350"> +374 55 75-73-50 </a><a href="callto:+37433757350"> +374 33 75-73-50 </a>
                    </p>
                    ...
                    <div class="list ">
                        ...
                        <p>
                            <a href="https://twitter.com/colibri_lab?s=09" target="_blank"> <i
                ...
                <iframe
                        ...
                        width="100%" height="442" frameborder="0" style="border:0;" allowfullscreen=""
                        aria-hidden="false"
                        tabindex="0"></iframe>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#button').click(function () {
                ...
                let course_type = course.split(' ').slice(0,2).join('-');

                var preferredTimes = $('#course_time input:checked');
                selectedTimeZone = '';
                if (preferredTimes.length) {
                    var selectedTimeZone = [];
                    preferredTimes.each(function () {
                        selectedTimeZone.push(this.value);
                    });
                ...
                //     return;
                // }
                let students_count = $('#students_count').find(":selected").text();
                students_count =  students_count.split(' ').slice(0,2).join(' ');
