                    ...
                    <ul>
                        ...
                        <li data-index="rs-10" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <div class="tp-caption  " id="slide-10-layer-4"
                                ...
                                data-paddingleft="[0,0,0,0]" data-blendmode="screen" style="z-index: 5;"><img
                            ...
                            <div class="tp-caption   tp-resizeme" id="slide-10-layer-8"
                                ...
                                data-width="['none','none','361','330']" data-height="none"
                                data-whitespace="['nowrap','nowrap','normal','normal']" data-type="text"
                                data-responsive_offset="on" data-wrapper_class="tp-nopointer"
                        ...
                        <li data-index="rs-12" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <!-- LAYER NR. 9 -->
                            <div class="tp-caption   fullscreenvideo  disabled_lc tp-videolayer" id="slide-12-layer-12"
                                data-x="0" data-y="0" data-whitespace="nowrap" data-type="video" data-basealign="slide"
                                ...
                                data-paddingleft="[0,0,0,0]" data-blendmode="screen" data-autoplay="on"
                                style="z-index: 5;">
                            ...
                            <div class="tp-caption   tp-resizeme size-header" id="slide-12-layer-6"
                                ...
                                data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[20,20,20,20]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[20,20,20,20]" data-blendmode="exclusion"
                            ...
                            <a class="tp-caption rev-btn  tp-resizeme"
                                ...
                                target="_blank" id="slide-12-layer-10" data-x="['center','center','center','center']"
                                data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                                data-voffset="['70','40','60','60']" data-width="none" data-height="none"
                ...
                <div class="pulseDiv1">
                    <span class="pulse">
                        <div class="wrapper">
                            ...
                            <div class="tooltip "> <span style="font-size: 16px;">{{__('home.comecolibrilab')}}</span>
                            </div>
                        </div>
                    </span>
                </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="tabs_item_content">
                                    ...
                                    <a href="" class="btn" data-toggle="modal"
                                        data-target="#myModal2">{{__('home.learnmore')}}</a>
                                    <!-- The Modal -->
        ...
        <div class="reg_form" id="tabs">
            <div class="reg">
                ...
                <fieldset id="tabs-1">
                    ...
                    <input class="cv_name" type="text" id="cv_name" placeholder="{{__('home.name')}}">
                    ...
                    <div class="IagreeDiv">
                        ...
                        <span>{{__('home.agree')}} <a href="{{__('home.policy_link')}}">
                                {{__('home.chapter')}}</a></span>
                    </div>
                    <div class="but">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="contact-box" style="padding: 47px 20px;
                    ...
                    <p><a href="https://goo.gl/maps/Ld22zFYgNaXCDDM29"
                            target="_blank">{{__('home.yerevan')}}<br>{{__('home.address')}}</a></p>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            <textarea name="message" class="form-control " cols="30" rows="4" name="message"
                                id="message" placeholder="{{__('home.enteryourmessage')}}"
