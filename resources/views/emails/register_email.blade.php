                                        ...
                                        <tr>
                                            <td>
                                                <table style='width: 100%;max-width: 900px' align='center'>
                                                    ...
                                                    <tr  align='center'>
                                                        <td align='left'><p  style='color:#272727;font:bold 20px sans-serif'>{{$details['name']}}</p></td>
                                    ...
                                    <table align='center' bgcolor='#F6FAFF' width='100%' style='border-radius: 10px;width: 100%;max-width: 1050px;padding: 10px;'>
                                        <tr>
                                            <td>
                                                <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center' style='width: 100%;max-width: 900px;'>
                                                    <tr>
                                                        <td><h1 style='font:bold 18px sans-serif'>{{$details['course_type']}}</h1></td>
                                ...
                                <td>
                                    <table  border='0' cellpadding='0' cellspacing='0' width='100%' align='center' style='width: 100%;max-width: 900px;'>
                                        <tr>
                                            ...
                                            <td align='left'><h1 style='font:bold 25px sans-serif;Margin-top:20px;'>{{$details['students_count']}}</h1></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
