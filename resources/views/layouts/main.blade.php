...
ծրագրավորում php,react ծրագրավորում,ծրագրավորում react,python ծրագրավորում,ծրագրավորում python" />
    ...
    <link rel='stylesheet' href="{{asset('css/revolution.addon.particles.css?ver=1.0.3')}}" type='text/css'
        media='all' />
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="{{url('/')}}">
                <img src="{{asset('/images/logo.png')}}" alt="logo" width="86.91" height="61.1px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger clav"
                            href="{{Route('home')}}/#eduservices-pricing">{{__('home.courses')}}</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger"
                            href="{{Route('home')}}/#eduservices-blog">{{__('home.portfolio')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger"
                            href="{{Route('home')}}/#eduservices-teacher">{{__('home.ourteam')}}</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger"
                            href="{{Route('home')}}/#eduservices-testimonial">{{__('home.opinions')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger"
                            href="{{Route('home')}}/#eduservices-contact">{{__('home.contact')}}</a>
                    </li>
                    <div class="dropdown">
                        <li class="nav-item other5">
                            <a class="nav-link js-scroll-trigger other6" id="dropdownMenuButton" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">{{__('home.other')}}
                            </a>
                            <a class="nav-link js-scroll-trigger ana" id="dropdownMenuButton" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">{{__('main_lang.create_cv')}}
                            </a>
                            <a class="nav-link js-scroll-trigger ana" id="dropdownMenuButton" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">{{__('main_lang.testspeed')}}
                            </a>
                            <a class="nav-link js-scroll-trigger ana" id="dropdownMenuButton" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">{{__('main_lang.faq')}}
                            </a>


                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item kap" href="{{url('/#eduservices-contact')}}"></a>
                                <a class="dropdown-item cv_crate" href="{{url('/#createcv')}}"></a>
                                <a class="dropdown-item typing" href="{{url('/typing_test')}}" target="_blank"></a>
                                <a class="dropdown-item hth" href="{{url('/FAQ')}}" target="_blank"></a>
                                {{--								<a class="dropdown-item" href="#">{{__('main_lang.opinion')}}</a>--}}
                            </div>
                    </div>
                    </li>
                    <li class="nav-item buttonik">
                        <a class="nav-link js-scroll-trigger  login"
                            href="{{url('register')}}">{{__('home.signup')}}</a>
                    </li>
                        ...
                        <div class="chooseLang">
                            ...
                            <div>
                                <span id="es-lang" class="lang am-lang {{$is_arm}}"
                                    onclick="changeLang('arm', this)"></span>
                                <span id="en-lang" class="lang en-lang {{$is_eng}}"
    ...
    <div style="display: flex;justify-content: center;padding: 20px 0; height: 0">
        <section class="footer1">
            <div class="footer1-content">
                ...
                <div class="  ajakicner">
                    <a href="http://localhost:8000/FAQ" class="aj">{{__('home.hth')}}</a>
                </div>

                <a href="{{url('/FAQ')}}" class="hth" style=" font-size: 20px"
                    target="_blank">{{__('home.frequently_questions')}}</a>
                <a href="#" class="border"></a>
                <a href="{{url('/discount_policy')}}" class="zex" style="font-size: 20px "
                    target="_blank">{{__('home.discount_policy')}}</a><br>
                <a href="{{url('/Privacy')}}" class="anv" style=" font-size: 20px "
                    target="_blank">{{__('home.security_policy')}}</a>
                <p style="color: white; text-align: center; padding-top: 30px;font-size:20px" class="col">2022
                    Rootteam development company</p>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link js-scroll-trigger clav" href="#eduservices-pricing">{{__('home.courses')}}</a>
					</li>
					<li class="nav-item">
...
{{--								<a class="dropdown-item" href="#">{{__('main_lang.opinion')}}</a>--}}
	...
	<script src="{{asset('js/script.js')}}"></script>
	<script src="{{asset('js/footer.js')}}"></script>
>>>>>>> 072f3f983defaf3c163f80aaa76e6e9beb5bce32
